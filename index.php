                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <div class="dropdown">
                                <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                                    <div class="user-menu d-flex">
                                        <div class="user-name text-end me-3">
                                            <h6 class="mb-0 text-gray-600"><?php if(isset($_SESSION['active_user'])) echo $_SESSION['active_user']->name; ?></h6>
                                            <p class="mb-0 text-sm text-gray-600"><?php if(isset($_SESSION['active_user'])) echo $_SESSION['active_user']->role; ?></p>
                                        </div>
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                                    <li>
                                        <h6 class="dropdown-header">Hello, <?php if(isset($_SESSION['active_user'])) echo explode(' ',$_SESSION['active_user']->name)[0]; ?>!</h6>
                                    </li>
                                    <li><a class="dropdown-item" href="index.php?page=staff_detail&mode=update&id=<?php if(isset($_SESSION['active_user'])) echo $_SESSION['active_user']->id ?>"><i class="icon-mid bi bi-person me-2"></i> My
                                            Profile</a></li>
            ...
            <div id="main-content">
                ...
                <!-- <section class="row">
                    <div class="col-12 col-lg-9">
                        <div class="row">
                            <div class="col-6 col-lg-3 col-md-6">tes</div>
                        </div>
                         <div class="row">
