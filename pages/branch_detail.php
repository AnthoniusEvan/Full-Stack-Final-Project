...
<div class="card">
        ...
        <?php
            ...
            switch($mode){
                ...
                case "update":
                    ...
                    $resultSet = $branch->get_data($col, "Id=$id", 1);
                    if ($resultSet){
                        $row=$resultSet->fetch_array();
                    }
                    else{
                        die('Incorrect branch ID');
                    }
    ...
    <div class="row card-body" style="padding-bottom:20px;">
        <div class="col-lg-12">
            <form enctype="multipart/form-data" method="POST" action="index.php?page=branches_list">
                ...
                <div class="row" style="margin-top: 30px">
                    <div class="col-sm-4">
                        <a href="index.php?page=branches_list"><button type="button" class="btn btn-warning">Cancel</button></a>
                    </div>
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header bg-danger">
                                                    <h5 class="modal-title white" id="myModalLabel120">
                                                        Delete branch "<?php echo $row['Name']; ?>"?
                                                    </h5>
                                                ...
                                                <div class="modal-body" style="text-align:justify;">
                                                    Deleting a branch that is related to other data might cause an error. Would you like to continue?
                                                </div>
